"""AI Pipeline services with SmartRouter integration."""
...
class IntentClassificationService:
    ...
    async def classify(
    ...
    ) -> tuple[Intent | None, Template | None, float]:
        """
        ...
        stmt = select(Intent).where((Intent.tenant_id == tenant_id) | (Intent.tenant_id.is_(None)))
...
class AIDocumentPipeline:
    ...
    async def process_message(
        ...
        tenant_id: UUID,
        source: str = "manual",
        force_template_id: UUID | None = None,
    ) -> dict:
        """
    ...
    async def generate_response(
        ...
        """Generate a response using AI manager with SmartRouter."""
        try:
            # Use the AI manager to generate response with SmartRouter
            ...
            # In a real implementation, you might want to log and handle this differently
            raise e
